...
export default function HufflepuffStaff(props) {
    ...
    return (
        <div>
             <div>
                <Link to="/Characters/Hogwarts/Hufflepuff"><button className="back-btn">Back</button></Link>
            </div>
            <div className="character-grid">
            {
                props.characters.map((character, index) => {
                if (character.house === 'Hufflepuff' && character.hogwartsStaff && character.image) {
                    return (
                ...
                } else if (character.house === 'Hufflepuff' && character.hogwartsStaff && !character.image) {
                    return (
                        <div className="characterCard" key={index} onClick={() => showCharacter(index)}>

...
export default function SlytherinStudentPage(props) {
    ...
    if (character.image && character.dateOfBirth !== null) {
        return (
            <div className="smallSlytherinCard">
                <div className="details-btn">
                    <Link to="/Characters/Hogwarts/Slytherin/students"><button className="back-btn">Back</button></Link>
                </div>
